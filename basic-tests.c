 ...
 */
  ...
  * according to the ARGUS (arguments) constant. Initialization of the arrays to fill the DRAM with random
  * numbers.
 ...
 /* Performance measurement. */
  ...
  if(ARGUS == 1)
    ...
    if (ARGUS > 3)
      ...
      l3_in6      = (__host int32_t*)hero_l3malloc(MAX_H*MAX_W*sizeof(int32_t)/ARGUS);
      l3_in7      = (__host int32_t*)hero_l3malloc(MAX_H*MAX_W*sizeof(int32_t)/ARGUS);
      l3_in8      = (__host int32_t*)hero_l3malloc(MAX_H*MAX_W*sizeof(int32_t)/ARGUS);
    if (ARGUS > 4)
      l3_in9      = (__host int32_t*)hero_l3malloc(MAX_H*MAX_W*sizeof(int32_t)/ARGUS);
      l3_in10     = (__host int32_t*)hero_l3malloc(MAX_H*MAX_W*sizeof(int32_t)/ARGUS);
      l3_in11     = (__host int32_t*)hero_l3malloc(MAX_H*MAX_W*sizeof(int32_t)/ARGUS);
      l3_in12     = (__host int32_t*)hero_l3malloc(MAX_H*MAX_W*sizeof(int32_t)/ARGUS);
      l3_in13     = (__host int32_t*)hero_l3malloc(MAX_H*MAX_W*sizeof(int32_t)/ARGUS);
      l3_in14     = (__host int32_t*)hero_l3malloc(MAX_H*MAX_W*sizeof(int32_t)/ARGUS);
      l3_in15     = (__host int32_t*)hero_l3malloc(MAX_H*MAX_W*sizeof(int32_t)/ARGUS);
      l3_in16     = (__host int32_t*)hero_l3malloc(MAX_H*MAX_W*sizeof(int32_t)/ARGUS);
  } 
      ...
      if(HEAVY_COMP==1){
        if(!IFTOFROM){
          ...
          if (ARGUS == 1){
            ...
            clock_gettime(CLOCK_REALTIME, &t_offl_0);
            #pragma omp target device(BIGPULP_MEMCPY) map(to: l3_in1[0:width*height], l3_in2[0:width*height], l3_in3[0:width*height], l3_in4[0:width*height],\
          ...
          if (ARGUS == 1){
            ...
            clock_gettime(CLOCK_REALTIME, &t_offl_0);
            #pragma omp target device(BIGPULP_MEMCPY) map(tofrom: l3_in1[0:width*height], l3_in2[0:width*height], l3_in3[0:width*height], l3_in4[0:width*height],\
                                                              l3_in5[0:width*height], l3_in6[0:width*height], l3_in7[0:width*height], l3_in8[0:width*height]) nowait
              array8_comp(l3_in1, l3_in2, l3_in3, l3_in4,l3_in5, l3_in6, l3_in7, l3_in8, width, height );
            clock_gettime(CLOCK_REALTIME, &t_offl_1);
          } else if(ARGUS == 5){
